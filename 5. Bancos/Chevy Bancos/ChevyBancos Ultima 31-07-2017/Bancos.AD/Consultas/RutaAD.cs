...
namespace Bancos.AD.Consultas
{
    public class RutaAD
    {
        ...
        public String consultarRutaEntrada(String codigoBanco) //no se esta usando
        {
            String query = "SELECT R.RUTA"
                + " FROM tb_BAN_RUTA R, tb_BAN_BANCO B"
                + " WHERE R.OID = B.Ruta_Archivos_Entrada"
                + " AND B.ID_CUENTA_BANCO = '" + codigoBanco + "'",
                ruta = String.Empty;
        ...
        public String consultarRutaSalida(String codigoBanco) //no se esta usando
        {
            String query = "SELECT R.RUTA"
                + " FROM tb_BAN_RUTA R, tb_BAN_BANCO B"
                + " WHERE R.OID = B.Ruta_Archivos_Salida_Epicor"
                + " AND B.ID_CUENTA_BANCO = '" + codigoBanco + "'",
                ruta = String.Empty;
