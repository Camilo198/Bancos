<%@ Page Title="Interpretar Respuestas" Language="C#" MasterPageFile="~/PaginaMaestra/Sitio.Master"
    AutoEventWireup="true" CodeBehind="DeRespuestas.aspx.cs" Inherits="Bancos.PS.Modulos.Interpretaciones.DeRespuestas" %>
            ...
            <table style="width: 100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="BarraSubTitulo">
                        Definir la Reinterpretación de las Respuestas entre Bancos y Asobancaria
                    </td>
                </tr>
                <tr>
                        ...
                        <asp:Panel ID="pnlPrincipal" runat="server" ScrollBars="Auto" Width="100%" Height="620px">
                                                ...
                                                <tr>
                                                    <td colspan="4" style="text-align: center">
                                                        <asp:ImageButton ID="imgBtnFiltrar" runat="server" ToolTip="Filtar campos." ImageUrl="~/MarcaVisual/iconos/buscar.png"
                                                            OnClick="imgBtnFiltrar_Click" Height="16px" ValidationGroup="1" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
                            ...
                            <asp:GridView ID="gvRespuestas" runat="server" AutoGenerateColumns="False" Width="99%"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="pRespuestaTBanco" DataField="pRespuestaTBanco" ItemStyle-CssClass="OcultarControles"
                                        HeaderStyle-CssClass="OcultarControles">
                                        <HeaderStyle CssClass="OcultarControles" />
                                        <ItemStyle CssClass="OcultarControles" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="pRespuestaTAsoba" DataField="pRespuestaTAsoba" ItemStyle-CssClass="OcultarControles"
                                        HeaderStyle-CssClass="OcultarControles">
                                        <HeaderStyle CssClass="OcultarControles" />
                                        <ItemStyle CssClass="OcultarControles" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="Código Respuesta Banco" DataField="pCodigoRespuestaTBanco" />
                                    <asp:BoundField HeaderText="Detalle Respuesta Banco" DataField="pDetalleRespuestaTBanco" />
                                    <asp:BoundField HeaderText="Código Respuesta Asobancaria" DataField="pCodigoRespuestaTAsoba" />
                                    <asp:BoundField HeaderText="Detalle Respuesta Asobancaria" DataField="pDetalleRespuestaTAsoba" />
                                </Columns>
