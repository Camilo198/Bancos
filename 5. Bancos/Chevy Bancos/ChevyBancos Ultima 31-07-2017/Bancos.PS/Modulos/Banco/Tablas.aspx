<%@ Page Title="Bancos - Tablas" Language="C#" MasterPageFile="~/PaginaMaestra/Sitio.Master"
    AutoEventWireup="true" CodeBehind="Tablas.aspx.cs" Inherits="Bancos.PS.Modulos.Banco.Tablas" %>
                    ...
                    <td>
                        <asp:Panel ID="pnlPrincipal" runat="server" ScrollBars="Auto" Width="100%" Height="620px">
                            ...
                            <asp:GridView ID="gvTablas" runat="server" AutoGenerateColumns="False" Width="99%"
                                ...
                                GridLines="Horizontal" OnRowCommand="gvTablas_RowCommand" PageSize="5" 
                                OnPageIndexChanging="gvTablas_PageIndexChanging" AllowPaging="True">
                                <Columns>
                            ...
                            <asp:Panel ID="pnlEstructura" CssClass="PanelBordesRedondos" runat="server" Width="99%">
                                <table style="width: 100%" cellpadding="0" cellspacing="2">
                                    ...
                                    <tr>
                                        ...
                                        <td class="EspaciadoCeldaControl">
                                            <asp:TextBox ID="txbCodigo" CssClass="BordeControles" ValidationGroup="3" MaxLength="10"
                                                runat="server"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvCodigo" runat="server" ErrorMessage="Favor digitar el código de para la descripción!"
                                        ...
                                        <td class="EstiloEtiquetas">
                                            <asp:Label ID="lbDesc" runat="server" Text="Descripción:"></asp:Label>
                                        </td>
                                        <td class="EspaciadoIntermedio">
                                        </td>
                                        <td class="EspaciadoCeldaControl">
                                            <asp:TextBox ID="txbDesc" CssClass="BordeControles" ValidationGroup="3" MaxLength="60"
                                                runat="server"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvDesc" runat="server" ErrorMessage="Favor digitar la descripción!"
                                        ...
                                        <td class="EspaciadoFinal">
                                            <asp:ImageButton ID="imgBtnAddValor" runat="server" 
                                                ImageUrl="~/MarcaVisual/iconos/agregar.png" onclick="imgBtnAddValor_Click" 
                                                ToolTip="Almacenar valor." ValidationGroup="3" Width="16px" />
                                        </td>
                                    </tr>
                                </table>
                            </asp:Panel>
                            ...
                            <asp:GridView ID="gvValores" runat="server" AutoGenerateColumns="False" Width="99%"
                                ...
                                OnPageIndexChanging="gvValores_PageIndexChanging" PageSize="8">
                                <Columns>
                                    <asp:ButtonField ButtonType="Image" CommandName="Editar" ImageUrl="~/MarcaVisual/iconos/editar.png"
                                        Text="Editar">
                                        <ItemStyle Width="30px" />
                                    ...
                                    <asp:BoundField HeaderText="Código" DataField="pCodigo"></asp:BoundField>
                                    <asp:BoundField HeaderText="Descripción" DataField="pDescripcion"></asp:BoundField>
                                </Columns>
                                <HeaderStyle BackColor="#C5C5C6" />
                                <RowStyle HorizontalAlign="Center" BorderStyle="Solid" BorderWidth="1pt" />
                                <PagerStyle BackColor="#C5C5C6" Font-Strikeout="False" Font-Underline="False" />
