...
namespace Pagos.LN
{
    ...
    public class WcfUtilidades : IWcfUtilidades
    {
        ...
        Pagos.AD.Servicios.WcfData wsc = new Pagos.AD.Servicios.WcfData();
        ...
        public IList<String> LeerFicheroFTP(string NombreArchivo, string UsuFTP, string PassFTP, out String mensaje, string fechaPago = "", int codigoBanco = 0)
        {
            ...
            IList<String> texto = new List<String>();
            ...
            try
            {
                ...
                if (res == "S")
                {
                    foreach (var linea in File.ReadLines(Repositorio + NombreArchivo))
                    {
                        texto.Add(linea);
                    }
                    mensaje = "OK";
                ...
                {
                    texto = new List<string>();
                    mensaje = "Error al consultar el archivo "+ NombreArchivo + "en el FTP de SICO "+ res;
                }
